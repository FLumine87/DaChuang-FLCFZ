...
2. 访问 [Docker Desktop for Windows](https://www.docker.com/products/docker-desktop) 下载安装包
3. 运行安装程序，按照提示完成安装（确保勾选"Use WSL 2 instead of Hyper-V"选项）
4. 安装完成后重启电脑
5. 启动Docker Desktop（会在系统托盘显示）
